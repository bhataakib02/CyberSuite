      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
        ...
        <div className="flex bg-zinc-900/50 p-1.5 rounded-2xl border border-white/5 backdrop-blur-xl">
          <button 
            ...
            className={`px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === 'CORE' ? 'bg-white/10 text-white shadow-lg' : 'text-zinc-500 hover:text-zinc-300'}`}
          >
            Core Personal
          </button>
          <button 
            onClick={() => setActiveTab('PROFESSIONAL')}
            className={`px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === 'PROFESSIONAL' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-zinc-500 hover:text-zinc-300'}`}
          >
            Professional Mode
          </button>
        </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={s.label} className="bg-zinc-900/40 border border-white/5 p-8 rounded-[2.5rem] relative overflow-hidden group hover:border-white/10 transition-all">
                  ...
                  <p className="text-[9px] text-zinc-600 font-bold uppercase mt-2">{s.desc}</p>
                </div>
              ))}
            </div>
